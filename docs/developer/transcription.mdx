---
title: "Transcription"
description: "How Whisper-based audio transcription works in punsVC"
---

## Overview

punsVC uses OpenAI's Whisper model for automatic speech recognition (ASR). This powers the transcription feature for creating reference text from audio recordings.
...
Whisper supports 99+ languages. Common ones in punsVC:
