...
description: "How voice profile management works in punsVC"
---

## Overview

Voice profiles are the foundation of punsVC's voice cloning capability. Each profile stores reference audio samples and metadata that the TTS model uses to clone a voice.
