...
punsVC uses Tauri's built-in auto-updater to deliver updates to users automatically.
...
1. **Check for Updates** - The punsVC app periodically checks GitHub Releases for new versions
