---
title: "Introduction"
description: "Welcome to punsVC - the open-source voice synthesis studio"
---
...
<Frame>
  <img src="/images/app-screenshot-1.webp" alt="punsVC App Screenshot" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Installation" icon="download" href="/overview/installation">
    Download and install punsVC on your machine
  </Card>
