...
| Platform | Download |
|----------|----------|
| macOS (Apple Silicon) | [Voicebox_0.1.13_aarch64.dmg](https://github.com/AGF21/VC/releases/download/v0.1.13/Voicebox_0.1.13_aarch64.dmg) |
| macOS (Intel) | [Voicebox_0.1.13_x64.dmg](https://github.com/AGF21/VC/releases/download/v0.1.13/Voicebox_0.1.13_x64.dmg) |
| Windows (MSI) | [Voicebox_0.1.13_x64_en-US.msi](https://github.com/AGF21/VC/releases/download/v0.1.13/Voicebox_0.1.13_x64_en-US.msi) |
| Windows (Setup) | [Voicebox_0.1.13_x64-setup.exe](https://github.com/AGF21/VC/releases/download/v0.1.13/Voicebox_0.1.13_x64-setup.exe) |
